...
## Introduction
This module shows the departure times of public transport grouped by stops and destination of choiche. In this example you see the stops De Lanen and Leidschenveen. Leidschenveen is a LightRail hub that services. It serves lines 3,4, E, 19, 30, and N5. In this example not all of these lines are used in the time table. The lines are grouped to their destination, instead on line number.
